#ifndef _RENDER_METHOD_PHONG_DIRECTONAL_CG_H_
#define _RENDER_METHOD_PHONG_DIRECTONAL_CG_H_

#include "RenderMethod.h"

/** Renders a model with diffuse gouraud shading and texturing */
class RenderMethod_PhongDirectional_CG : public RenderMethod {
public:
	/** Constructor */
	RenderMethod_PhongDirectional_CG(class Renderer *r);
