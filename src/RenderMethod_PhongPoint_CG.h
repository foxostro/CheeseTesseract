#ifndef _RENDER_METHOD_PHONG_POINT_CG_H_
#define _RENDER_METHOD_PHONG_POINT_CG_H_

#include "RenderMethod.h"

/** Renders a model with diffuse gouraud shading and texturing */
class RenderMethod_PhongPoint_CG : public RenderMethod {
public:
	/** Constructor */
	RenderMethod_PhongPoint_CG(class Renderer *r);
